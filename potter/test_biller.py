...
def test_with_two_identical_books():
    biller = Biller([FIRST_BOOK, FIRST_BOOK])
    result = biller.bill()
    expected = 16
...
def test_with_two_different_books():
    biller = Biller([FIRST_BOOK, SECOND_BOOK])
    result = biller.bill()
    expected = 15.2
...
def test_with_two_identical_books_and_a_different_one():
    biller = Biller([FIRST_BOOK,SECOND_BOOK,FIRST_BOOK])
    result = biller.bill()
    expected = 23.2
...
def test_with_two_identical_books_and_a_different_one_in_a_different_order():
    biller = Biller([FIRST_BOOK,FIRST_BOOK,SECOND_BOOK])
    result = biller.bill()
    expected = 23.2
...
def test_with_three_identical_books():
    biller = Biller([FIRST_BOOK,FIRST_BOOK,FIRST_BOOK])
    result = biller.bill()
    expected = 24
...
def test_with_three_different_books():
    biller = Biller([FIRST_BOOK,SECOND_BOOK,THIRD_BOOK])
    result = biller.bill()
    expected = 21.6
...
def test_with_four_different_books():
    biller = Biller([FIRST_BOOK,SECOND_BOOK,THIRD_BOOK, FOURTH_BOOK])
    result = biller.bill()
    expected = 25.6
...
def test_with_four_identical_books():
    biller = Biller([FIRST_BOOK,FIRST_BOOK,FIRST_BOOK,FIRST_BOOK])
    result = biller.bill()
    expected = 32
...
def test_ultimate():
    biller = Biller([FIRST_BOOK,FIRST_BOOK,SECOND_BOOK,SECOND_BOOK,THIRD_BOOK,THIRD_BOOK,FOURTH_BOOK,FIFTH_BOOK])
    result = biller.bill()
    expected = 51.60
...
def test_get_books_counts():
    biller = Biller([FIRST_BOOK, FIRST_BOOK, SECOND_BOOK, THIRD_BOOK, FOURTH_BOOK, FOURTH_BOOK])
